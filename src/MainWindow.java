...
public class MainWindow {
  ...
  */
  ...
  /*Diese Funktion wir vom SortChannels aufgerufen und muss dann die combobox erneuuern.*/
  public void setChannels(ArrayList<kanal> blub){
    /*for (int i = 0; i < blub.size() - 1; i++) {
      System.out.println(blub.get(i).getProgramm());
    } // end of for
    */
  }
