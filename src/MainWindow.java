...
public class MainWindow {
  ...
  */
  ...
  private void initialize() {
    ...
    //final JPanel 
    pipPanel = new JPanel();
    pipPanel.setBorder(UIManager.getBorder("OptionsPane.border"));
    pipPanel.setBounds(953, -5, 351, 241);
    pnlViewArea.add(pipPanel);
    ...
    btoption = new JButton("Settings Einblenden");
    btoption.setBounds(50, 47, 155, 23);
    ...
    btoption.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        if (settingsButtonPressed == false){
          ...
          btoption.setText("Settings Ausblenden");
        }else if (settingsButtonPressed == true){
          
          settingsPanel.setVisible(false);
          btoption.setText("Settings Einblenden");
        }
  ...
  */
  ...
  private void initializeOverlay() {
    ...
    pbtoverlay.setBounds(485, 509, 256, 183);
    viewArea.add(pbtoverlay);
    pbtoverlay.setBackground(Color.LIGHT_GRAY);
